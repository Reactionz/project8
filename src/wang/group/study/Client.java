...
//	String hostAddress = "odin.cs.csub.edu";
	...
	public Client() {
		...
		repDialog = new RepDialog(this, true);
	...
	class RepDialog extends JDialog {
		...
		public RepDialog(final JFrame parent, boolean modal) {
			initializeGUI();
		}
		...
		public void initializeGUI() {
			...
			msgBoard2.setBackground(Color.black);
		...
		void addListeners() {
			...
			tfNameMsg2[0].addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					visitorName2 = new String(tfNameMsg2[0].getText()).trim();
